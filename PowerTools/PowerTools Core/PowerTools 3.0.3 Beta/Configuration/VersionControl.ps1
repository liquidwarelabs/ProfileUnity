...
function Backup-ProUConfigurationState {
    ...
    try {
        ...
        $configurations = if ($ConfigurationName) {
            Get-ProUConfigss | Where-Object { $_.Name -eq $ConfigurationName }
        } else {
            Get-ProUConfigs
        }
...
function Compare-ProUConfigurations {
    ...
    try {
        ...
        $config1 = Get-ProUConfigs | Where-Object { $_.Name -eq $Configuration1 }
        $config2 = Get-ProUConfigs | Where-Object { $_.Name -eq $Configuration2 }
