...
# Last, reconfigure ProfileUnity Client Tools - if installed
Write-Host "Attempting to reconfigure by running local Startup.Update.exe..." -ForegroundColor GREEN
...
} Else { Write-Host "No ProfileUnity Client Tools installation found!" -ForegroundColor RED 
}
Write-Host